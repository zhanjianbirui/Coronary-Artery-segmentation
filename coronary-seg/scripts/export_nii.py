#!/usr/bin/env python3
"""
scripts/export_nii.py — 把指定病例的各阶段分割结果导出成 .nii.gz
==================================================================
...
用法（在集群上跑）：
  PYTHONPATH=. python scripts/export_nii.py \
...
from scripts.predict_stage2 import load_npz, postprocess, infer_case
