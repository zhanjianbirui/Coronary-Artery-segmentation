#!/usr/bin/env python3
"""
scripts/data/stage2_prepare.py — 阶段2训练数据准备
==================================================================
...
用法（单轴，旧）：
  PYTHONPATH=. python scripts/data/stage2_prepare.py \
...
from scripts.predict.predict import pad_to_multiple_2d
# 三正交逐轴推理+即时融合（内存友好，不同时保留三个概率体）
from scripts.predict.predict_tri import predict_tri_fused, predict_tri_probs
