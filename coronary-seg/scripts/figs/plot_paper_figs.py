#!/usr/bin/env python3
"""
scripts/figs/plot_paper_figs.py — 生成论文的 matplotlib 图（Fig. 6 / Fig. 7）
==================================================================
...
缺 csv 时会明确告诉你跑 ./scripts/data/fetch_paper_csv.sh，不会画出半张图。

用法：
  PYTHONPATH=. python scripts/figs/plot_paper_figs.py --out-dir <论文 images 目录>
  PYTHONPATH=. python scripts/figs/plot_paper_figs.py --out-dir images --only fig6
"""
