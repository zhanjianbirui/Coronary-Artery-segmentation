#!/usr/bin/env python3
"""
scripts/figs/vis_predict.py — 可视化指定病例的预测 vs 金标准
==================================================================
...
用法：
  PYTHONPATH=. python scripts/figs/vis_predict.py \
...
from scripts.predict.predict import predict_volume, remove_small_components
