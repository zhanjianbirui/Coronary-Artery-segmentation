#!/usr/bin/env python3
"""
scripts/figs/check_fig_assets.py — 核对 export_nii.py 导出的掩膜能否复现 csv 数字
==================================================================
...
用法：
  PYTHONPATH=. python scripts/figs/check_fig_assets.py 702
  PYTHONPATH=. python scripts/figs/check_fig_assets.py 702 --dir vis_nii
"""
