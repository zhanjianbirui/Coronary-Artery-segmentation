#!/usr/bin/env python3
"""
scripts/analysis/analyze_cases.py — 从预测结果 csv 分析病例表现
==================================================================
不重新推理，直接读 test_final_tta.csv，按 Dice/clDice 排序，
找出表现好/差的病例，以及"Dice和clDice不一致"的矛盾病例。

用法：
  PYTHONPATH=. python scripts/analysis/analyze_cases.py \
...
def main():
    ...
    print(f"\n  下一步可视化命令示例:")
    print(f"  PYTHONPATH=. python scripts/figs/vis_predict.py \\")
